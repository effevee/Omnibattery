...
6. Aplica una histéresis de 100 W: el offset solo se actualiza si cambia más de 100 W (omitida durante los últimos 10 minutos de la hora para que la hora se cierre con precisión).
