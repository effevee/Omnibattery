...
| **Potencia máxima de carga del sistema** | `0 W` | 0–25000 W | Límite opcional para la potencia de carga combinada. `0` lo desactiva. |
| **Potencia máxima de descarga del sistema** | `0 W` | 0–25000 W | Límite opcional para la potencia de descarga combinada. `0` lo desactiva. |
