...
AC-coupled 1600 AC+, 2400 AC+ and 4000 Mix AC+ models do not expose DC MPPT
telemetry through this connection.

Existing 2400 AC+ entries are promoted automatically when the device reports
the 4000 Mix AC+ product identifier. The saved user power ceilings are retained;
raise them in the battery options if you want to use the larger envelope.
